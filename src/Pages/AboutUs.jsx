...
const AboutUs = () => {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description:
        "Received 'Best Travel Tech Startup' award at India Tech Summit",
    },
    {
      year: "2024",
      title: "3 Million Users",
      description:
        "Crossed milestone of 3 million registered users on our platform",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
                ...
                >
                  ...
                  <div className="md:w-1/2">
                    <p className="text-gray-700 mb-4">
                      ListyGo was founded in 2020 with a simple mission: to make
                      travel accommodations more accessible, transparent, and
                      enjoyable for everyone.
                    </p>
                    <p className="text-gray-700 mb-4">
                      What started as a small startup in Baroda, Gujarat has
                      grown into a nationwide platform connecting travelers with
                      unique stays across India.
                    </p>
                    <p className="text-gray-700">
                      Our team combines expertise in hospitality, technology,
                      and customer service to create a seamless booking
                      experience that puts travelers first.
                    </p>
                  </div>
                </motion.div>
              ...
              <div>
                ...
                >
                  <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-500">
                    ...
                    <p className="text-gray-700">
                      To revolutionize the way people discover and book
                      accommodations by providing a platform that offers unique,
                      quality stays with transparency, reliability, and
                      exceptional service.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-md border-l-4 border-blue-500">
                    ...
                    <p className="text-gray-700">
                      To become the most trusted accommodation platform
                      globally, known for our diverse range of quality
                      properties and customer-centric approach.
                    </p>
                  </div>
                </motion.div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {[
                      ...
                      },
                      {
                        title: "Transparency",
                        description:
                          "We believe in being honest and clear in our communications and listings.",
                        icon: "🔍",
                      },
                      {
                        title: "Innovation",
                        description:
                          "We constantly seek new ways to improve our platform and user experience.",
                        icon: "💡",
                      },
                      {
                        title: "Quality",
                      ...
                      },
                      {
                        title: "Inclusivity",
                        description:
                          "We welcome all travelers and hosts from diverse backgrounds.",
                        icon: "🌈",
                      },
                      {
                        title: "Sustainability",
                        description:
                          "We promote responsible travel and environmentally-friendly practices.",
                        icon: "🌱",
                      },
                    ].map((value, index) => (
                      <div
            ...
            content={
              <div>
                <motion.p variants={fadeInUp} className="text-gray-700 mb-8">
                  Meet the dedicated professionals behind ListyGo. Our diverse
                  team brings together expertise from technology, hospitality,
                  and customer service to create an exceptional travel platform.
                </motion.p>
                ...
                <motion.div variants={fadeInUp} className="mt-12 text-center">
                  <h3 className="text-xl font-semibold text-gray-800 mb-6">
                    Why People Love Working at ListyGo
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-blue-50 p-5 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        A supportive environment where ideas are valued and
                        teamwork thrives
                      </p>
                    </div>
                    <div className="bg-blue-50 p-5 rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        Making a real difference in how people experience travel
                      </p>
                    </div>
                  </div>
                </motion.div>
          ...
          <RenderSection
            ...
            content={
              <div>
                <motion.p variants={fadeInUp} className="text-gray-700 mb-8">
                  Since our founding, we've expanded our presence across India
                  and are now taking our first steps into global markets.
                </motion.p>
                      ...
                      <div className="md:w-1/2">
                        ...
                        <div className="space-y-4">
                          {[
                            ...
                            {
                              region: "West India",
                              cities: "Mumbai, Pune, Ahmedabad, Baroda",
                              percentage: 35,
                            },
                            {
                              region: "East India",
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
              Join the ListyGo Journey
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Whether you're looking to book your next stay or partner with us
              as a property owner, we'd love to have you as part of our growing
              community.
            </p>
